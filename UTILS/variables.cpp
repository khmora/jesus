...
namespace FONTS
{
	...
	void InitFonts()
	{
		...
		bigtext = RENDER::CreateF("Night Machine[RUS by Daymarius]", 60, 550, 0, 0, NULL);
		numpad_menu_font = RENDER::CreateF("Verdana", 15, 600, 0, 0, SDK::FONTFLAG_OUTLINE);
		visuals_esp_font1 = RENDER::CreateF("Tahoma", 40, 300, 0, 0, SDK::FONTFLAG_DROPSHADOW);
		...
		visuals_lby_font = RENDER::CreateF("Calibri", 32, 650, 0, 0, SDK::FONTFLAG_ANTIALIAS | SDK::FONTFLAG_DROPSHADOW);
...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\Elevate.win\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\Elevate.win", NULL);
	...
	{
		std::string file_path = "C:\Elevate.win\\BlankConfig.cfg";
